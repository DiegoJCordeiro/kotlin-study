...
import br.com.diegocordeiro.kotlinstudy.infra.repositories.mongodb.ProductMongoRepositoryDAO
...
class ProductMongoRepositoryDAOTest {

    private lateinit var mongoDatabase: MongoDatabase
    private lateinit var collection: MongoCollection<Product>
    private lateinit var dao: ProductMongoRepositoryDAO
    private lateinit var insertResult: InsertManyResult

    private val testProduct: Product = createProduct()
    private val testProductList: List<Product> = createProductList()
    ...
    fun setup() {
        ...
        mongoDatabase = mock()
        collection = mock()
        whenever(mongoDatabase.getCollection<Product>(COLLECTION_NAME)).thenReturn(collection)
        dao = ProductMongoRepositoryDAO(mongoDatabase)
    }

    @Test
    fun `should return all products`() {
        val iterable: FindIterable<Product> = mock()
    ...
    @Test
    fun `should return products by filter`() {
    ...
    @Test
    fun `should insert one product`() {
        val result = dao.insertOne(testProduct)
        assertEquals(testProduct, result)
    }

    @Test
    fun `should insert many product`() {
    ...
    @Test
    fun `should update many products`() {
